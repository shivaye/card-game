...
<!-- Mirrored from template.hasthemes.com/strane/strane/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Aug 2021 17:18:54 GMT -->
<head>
    <meta charset="UTF-8">
            ...
            <div class="box-wrapper">
                ...
                <div class="contact-form-wrapper">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-10 offset-xl-1 col-12">
                                <form id="contact-form" class="default-form" action="https://whizthemes.com/mail-php/jaber/contact.php" method="post">
                                    <div class="row">
