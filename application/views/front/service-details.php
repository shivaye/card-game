...
<!-- Mirrored from template.hasthemes.com/strane/strane/service-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Aug 2021 17:18:47 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <main class="main-wrapper">
        ...
        <div class="service-details-section section-top-gap-150">
            <div class="box-wrapper">
                                ...
                                <div class="custome-container-with-sidebar d-flex flex-column-reverse flex-lg-row">
                                    ...
                                    <div class="container-width-63">
                                        <div class="default-text-content">
                                            <div class="default-content-hero-image">
                                                <img class="img-fluid" src="assets/images/service/service-details-hero-img.jpg" alt="">
                                            </div>

                                            <h2 class="subtitle">Good digital marketer understand the importance
                                            ...
                                            <ul class="default-iconic-item">
                                                <li>
                                                    <div class="icon">
                                                        <img src="assets/images/icons/promo/cyber-security.png" alt="">
                                                    </div>
                                                    <div class="content">
                                                        <h4 class="smalltitle">Secure & Private</h4>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="content">
                                                        <h4 class="smalltitle">Revenue Generation</h4>
                                                        <p>Lorem Ipsum is simply dummy text of the prnting and typesetting
                                                            industrys standard dummy text ever since the 1500s when an unknown
                                                            scrambled to make type specimen booked.</p>
                                                    </div>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="content">
                                                        <h4 class="smalltitle">Business Collaboration</h4>
                                                        <p>Lorem Ipsum is simply dummy text of the prnting and typesetting
                                                            industrys standard dummy text ever since the 1500s when an unknown
                                                            scrambled to make type specimen booked.</p>
                                                    </div>
