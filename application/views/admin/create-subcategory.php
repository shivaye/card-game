...
<head>
  ...
  <title><?=SITENAME;?> | Create SubCategory</title>
              ...
              <div class="card card-info">
                <div class="card-header">
                  <div class="card-tools">
                    <a class="btn btn-success" href="<?=base_url().'admin/subcategory/index';?>"><i class="fas fa-eye"></i> Manage</a>
                  </div>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <?=form_open_multipart('admin/subcategory/create');?>
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-4">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" placeholder="SubCategory Name" name="subcategory_name" id="subcategory_name" class="form-control <?php echo (form_error("subcategory_name")!="")? 'is-invalid':''; ?>" value="<?=set_value('subcategory_name');?>">
                        </div>
