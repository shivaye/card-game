...
<head>
  ...
  <title><?=SITENAME;?> | Manage Rejected Orders</title>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Manage Rejected Orders</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Manage Rejected Orders</li>
              </ol>
            </div>
          </div>
        </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $i=1;
                      foreach($getAllrejectedOrders as $category_row){
                    ?>
                    <tr>
                      <td><?=$i;?></td>
                      ...
                      <td><a href="<?=base_url()?>admin/order/orderdetail/<?=$category_row['trx_id']?>" class="btn-sm btn btn-info"><i class="fa fa-eye"></i></a></td>
                    </tr>
                    <?php
                    $i++;
                      }
