...
<head>
  ...
  <title><?=SITENAME;?> | Manage Banner</title>
             ...
             <div class="card">
              <div class="card-header">
                <div class="card-tools">
                  <a class="btn btn-primary" href="<?=base_url().'admin/banner/create';?>"><i class="fas fa-plus"></i> Create</a>
                </div>
              </div>
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?=$i;?></td>
                      <td><?php if($banner_row['image']!="" && file_exists('./public/uploads/banner/thumb/'.$banner_row['image'])){?>
                        <img src="<?=base_url().'public/uploads/banner/thumb/'.$banner_row['image']?>" alt="No image found" style="width: 150px; height: 150px;">
                        <?php
                          }else{
                        ?>
                      ...
                      <td><a href="<?=base_url().'admin/banner/edit/'.$banner_row['banner_id']?>" class="btn btn-info fa fa-edit"></a>  <a href="javascript:void(0)" onclick="deleteCategory('<?=$banner_row['banner_id']?>')" class="btn btn-danger fa fa-trash"></a></td>
                    </tr>
                    <?php
                    $i++;
                      }
