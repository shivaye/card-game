...
<head>
  ...
  <title><?=SITENAME;?> | Edit Testimonial</title>
              ...
              <div class="card card-info">
                <div class="card-header">
                  <div class="card-tools">
                    <a class="btn btn-success" href="<?=base_url().'admin/testimonial/index';?>"><i class="fas fa-previous"></i> Back</a>
                  </div>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <?=form_open_multipart('admin/testimonial/edit/'.$testimonial['testimonial_id']);?>
                  <div class="card-body">
                    <div class="row">
                     <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" placeholder="Name" name="name" id="name" class="form-control" value="<?=set_value('name',$testimonial['name']);?>">
                        </div>
                        <?=form_error("name");?>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <!-- <input type="text" placeholder="Button Link" name="btn_link" id="btn_link" class="form-control" value="<?=set_value('btn_link',$testimonial['btn_link']);?>"> -->
                          <textarea class="form-control" name="content" id="content"><?=set_value('content',$testimonial['content']);?></textarea>
                        </div>
                        <?=form_error("content");?>
                      </div>
                      <?php if($testimonial['image']!="" && file_exists('./public/uploads/testimonial/thumb/'.$testimonial['image'])){?>
                        <img src="<?=base_url().'public/uploads/testimonial/thumb/'.$testimonial['image']?>" alt="No image found">
                        <?php
                          }else{
                        ?>
