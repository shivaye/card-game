...
<head>
  ...
  <title><?=SITENAME;?> | Manage Inquiry</title>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Manage Inquiry</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Manage Inquiry</li>
              </ol>
            </div>
          </div>
        </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $i=1;
                      foreach($inquiry as $category_row){
                    ?>
                    <tr>
                      <td><?=$i;?></td>
                      ...
                      <td><?=$category_row['subject']?></td>
                      <td><?=$category_row['message']?></td>
                      <td><?=$category_row['date']?></td>
                    </tr>
                    <?php
                    $i++;
                      }
