...
<head>
  ...
  <title><?=SITENAME;?> | Edit Size</title>
              ...
              <div class="card card-info">
                <div class="card-header">
                  <div class="card-tools">
                    <a class="btn btn-success" href="<?=base_url().'admin/size/index';?>"><i class="fas fa-previous"></i> Back</a>
                  </div>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <?=form_open_multipart('admin/size/edit/'.$category['size_id']);?>
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="inputName">Size</label>
                          <input type="text" placeholder="Size" name="size" id="size" class="form-control" value="<?=set_value('size',$category['size']);?>">
                        </div>
                        <?=form_error("size");?>
                      </div>
                    </div>
