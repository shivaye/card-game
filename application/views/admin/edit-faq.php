              ...
              <div class="card card-info">
                <div class="card-header">
                  <div class="card-tools">
                    <a class="btn btn-success" href="<?=base_url().'admin/faq/index';?>"><i class="fas fa-previous"></i> Back</a>
                  </div>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <?=form_open_multipart('admin/faq/edit/'.$Faq['faq_id']);?>
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="inputName">Question</label>
                          <input type="text" placeholder="Question" name="question" id="question" class="form-control" value="<?=set_value('question',$Faq['question']);?>">
                        </div>
                        <?=form_error("question");?>
                      </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control textarea" name="answer" id="answer" placeholder="answer"><?=set_value('answer',$Faq['answer']);?></textarea>
                      </div>
                    </div>
                    </div>
                  </div>
