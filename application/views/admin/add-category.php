...
<head>
  ...
  <title><?=SITENAME;?> | Create Category</title>
              ...
              <div class="card card-info">
                <div class="card-header">
                  <div class="card-tools">
                    <a class="btn btn-success" href="<?=base_url().'admin/category/index';?>"><i class="fas fa-eye"></i> Manage</a>
                  </div>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" placeholder="Category Name" name="category_name" id="category_name" class="form-control <?php echo (form_error("category_name")!="")? 'is-invalid':''; ?>" value="<?=set_value('category_name');?>">
                        </div>
