...
<head>
  ...
  <title><?=SITENAME;?> | Manage New Orders</title>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Manage New Orders</h1>
            </div>
            <div class="col-sm-6">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $i=1;
                      foreach($getAllnewOrders as $category_row){
                    ?>
                    <tr>
                      <td><?=$i;?></td>
                     <td><?=$category_row['trx_id']?></td>
                      ...
                      <td>
                        <a href="javascript:void(0)" onclick="accepted_order('<?=$category_row['trx_id']?>')" class="btn-sm btn btn-success"><i class="fa fa-check"></i></a>
                        <a href="javascript:void(0)" class="btn-sm btn btn-danger" onclick="rejected_order('<?=$category_row['trx_id']?>')"><i class="fa fa-times"></i></a>
...
<script>
  ...
  function rejected_order(id)
  {
    if(confirm('Are You Sure Want To Cancel This Order'))
    {
      window.location.href='<?=base_url().'admin/order/rejected_order/';?>'+id;
    }
  }

  function accepted_order(id)
  {
    if(confirm('Are You Sure Want To Accept The Orders'))
    {
      window.location.href='<?=base_url().'admin/order/accepted_order/';?>'+id;
    }
  }
</script>
</body>
