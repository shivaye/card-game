...
<head>
  ...
  <title><?=SITENAME;?> | Manage Video</title>
             ...
             <div class="card">
              <div class="card-header">
                <div class="card-tools">
                  <a class="btn btn-primary" href="<?=base_url().'admin/video/create';?>"><i class="fas fa-plus"></i> Create</a>
                </div>
              </div>
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody class="row_position">
                    <?php
                    $i=1;
                      foreach($getAllvideo as $video_row){
                    ?>
                    <tr id="<?=$video_row['video_id'];?>">
                      <td><?=$i;?></td>
                      <td><?=$video_row['video_title']?></td>
                      <td><?=$video_row['video_link']?></td>
                      <?php
                        if($video_row['status']==1){
                          $class = "success";
                          $word = "Active";
                        }else{
                          $class = "danger";
                      ...
                      <td><a href="<?=base_url().'admin/video/edit/'.$video_row['video_id']?>" class="btn btn-info fa fa-edit"></a>  <a href="javascript:void(0)" onclick="deletePrize('<?=$video_row['video_id']?>')" class="btn btn-danger fa fa-trash"></a></td>
                    </tr>
                    <?php
                    $i++;
                      }
