...
<head>
  ...
  <title><?=SITENAME;?> | Create Size</title>
              ...
              <div class="card card-info">
                <div class="card-header">
                  <div class="card-tools">
                    <a class="btn btn-success" href="<?=base_url().'admin/size/index';?>"><i class="fas fa-eye"></i> Manage</a>
                  </div>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <?=form_open_multipart('admin/size/create');?>
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="inputName">Size</label>
                          <input type="text" placeholder="Size" name="size" id="size" class="form-control <?php echo (form_error("size")!="")? 'is-invalid':''; ?>" value="<?=set_value('size');?>">
                        </div>
                        <?=form_error("size");?>
                      </div>
                    </div>
