...
<head>
  ...
  <title><?=SITENAME;?> | Create Coupon</title>
              ...
              <div class="card card-info">
                <div class="card-header">
                  <div class="card-tools">
                    <a class="btn btn-success" href="<?=base_url().'admin/coupon/index';?>"><i class="fas fa-eye"></i> Manage</a>
                  </div>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <?=form_open_multipart('admin/coupon/create');?>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="inputName">Coupon Code</label>
                        <input type="text" placeholder="Coupon Code" name="coupon_code" id="coupon_code" class="form-control" value="<?=set_value('coupon_code');?>">
                      </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="date" placeholder="Start Date" name="start_date" id="start_date" class="form-control" value="<?=set_value('start_date');?>">
                      </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="date" placeholder="End Date" name="end_date" id="end_date" class="form-control" value="<?=set_value('end_date');?>">
                      </div>
                      <?=form_error("end_date");?>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" placeholder="Discount" name="amount" id="amount" class="form-control" value="">
                      </div>
                      <?=form_error("amount");?>
                    </div>
                    <div class="col-md-4">
