...
<head>
  ...
  <title><?=SITENAME;?> | Create Testimonial</title>
              ...
              <div class="card card-info">
                <div class="card-header">
                  <div class="card-tools">
                    <a class="btn btn-success" href="<?=base_url().'admin/testimonial/index';?>"><i class="fas fa-eye"></i> Manage</a>
                  </div>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <?=form_open_multipart('admin/testimonial/create');?>
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <!-- <input type="text" placeholder="Content" name="content" id="content" class="form-control" value=""> -->
