...
<head>
  ...
  <title><?=SITENAME;?> | Edit Brand</title>
              ...
              <div class="card card-info">
                <div class="card-header">
                  <div class="card-tools">
                    <a class="btn btn-success" href="<?=base_url().'admin/brands/index';?>"><i class="fas fa-previous"></i> Back</a>
                  </div>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <?=form_open_multipart('admin/brands/edit/'.$category['brand_id']);?>
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="inputName">Brand Name</label>
                          <input type="text" placeholder="Brand Name" name="brand_name" id="brand_name" class="form-control" value="<?=set_value('brand_name',$category['brand_name']);?>">
                        </div>
                      ...
                      <?php if($category['image']!="" && file_exists('./public/uploads/brands/thumb/'.$category['image'])){?>
                        <img src="<?=base_url().'public/uploads/brands/thumb/'.$category['image']?>" alt="No image found">
                        <?php
                          }else{
                        ?>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" placeholder="Meta Title" name="meta_title" id="meta_title" class="form-control" value="<?=set_value('meta_title',$category['meta_title']);?>">
                        </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" placeholder="Meta Description" name="meta_description" id="meta_description" class="form-control" value="<?=set_value('meta_description',$category['meta_description']);?>">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
