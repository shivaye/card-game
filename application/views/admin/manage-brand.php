...
<head>
  ...
  <title><?=SITENAME;?> | Manage Brand</title>
             ...
             <div class="card">
              <div class="card-header">
                <div class="card-tools">
                  <a class="btn btn-primary" href="<?=base_url().'admin/brands/create';?>"><i class="fas fa-plus"></i> Create</a>
                </div>
              </div>
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $i=1;
                      foreach($getAllBrands as $brand_row){
                    ?>
                    <tr>
                      <td><?=$i;?></td>
                      <td><?=$brand_row['brand_name']?></td>
                      <td><?php if($brand_row['image']!="" && file_exists('./public/uploads/brands/thumb/'.$brand_row['image'])){?>
                        <img src="<?=base_url().'public/uploads/brands/thumb/'.$brand_row['image']?>" alt="No image found" style="width: 150px; height: 150px;">
                        <?php
                          }else{
                        ?>
                      ...
                      <td><a href="<?=base_url().'admin/brands/edit/'.$brand_row['brand_id']?>" class="btn btn-info fa fa-edit"></a>
                      <a href="javascript:void(0)" onclick="deletebrand('<?=$brand_row['brand_id']?>')" class="btn btn-danger fa fa-trash"></a></td>
                    </tr>
                    <?php
                    $i++;
                      }
