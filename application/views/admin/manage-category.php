              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody class="row_position">
                    <?php
                    $i=1;
                      foreach($allCategory as $category_row){
                    ?>
                    <tr id="<?=$category_row['id'];?>">
                      <td><?=$i;?></td>
                      <td><?=$category_row['category_name']?></td>
                      <?php
                        if($category_row['is_active']=="Y"){
                          $class = "success";
                          $word = "Active";
                        }else{
                          $class = "danger";
                      ...
                      <td><a href="<?=base_url().'admin/category/edit/'.$category_row['id']?>" class="btn btn-info fa fa-edit"></a>  <a href="javascript:void(0)" onclick="deleteCategory('<?=$category_row['id']?>')" class="btn btn-danger fa fa-trash"></a></td>
                    </tr>
                    <?php
                    $i++;
                      }
